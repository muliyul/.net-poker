...
namespace BlackJack
{
    partial class BlackJackForm : Form , GameReference.IGameCallback
    {
        ...
        private void ShowBankValue()
        {
                ...
                myBetTextBox1.Text = "$" + game.CurrentPlayer.Bet.ToString();
        }
        ...
        private void LoadCardSkinImages()
        {
            ...
            playerCards = new PictureBox[] { player1Card1, player1Card2, playerCard3, player1Card4, player1Card5, player1Card6 };
        ...
        private void SetUpNewGame()
        {
            ...
            playerNameLabel1.Text = Properties.Settings.Default.PlayerName;
        ...
        private void UpdateUIPlayerCards()
        {
            ...
            playerTotalLabel1.Text = game.CurrentPlayer.Hand.GetSumOfHand().ToString();
