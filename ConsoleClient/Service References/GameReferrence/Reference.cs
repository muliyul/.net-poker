...
namespace ConsoleClient.GameReferrence {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="GameReferrence.IGame", SessionMode=System.ServiceModel.SessionMode.Required)]
    public interface IGame {
        ...
        ConsoleClient.GameReferrence.Player GetPlayerInfo(string user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGame/GetPlayerInfo", ReplyAction="http://tempuri.org/IGame/GetPlayerInfoResponse")]
        System.Threading.Tasks.Task<ConsoleClient.GameReferrence.Player> GetPlayerInfoAsync(string user);
        ...
        ConsoleClient.GameReferrence.Player GetMyInfo();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGame/GetMyInfo", ReplyAction="http://tempuri.org/IGame/GetMyInfoResponse")]
        System.Threading.Tasks.Task<ConsoleClient.GameReferrence.Player> GetMyInfoAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IGameChannel : ConsoleClient.GameReferrence.IGame, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class GameClient : System.ServiceModel.ClientBase<ConsoleClient.GameReferrence.IGame>, ConsoleClient.GameReferrence.IGame {
        ...
        public ConsoleClient.GameReferrence.Player GetPlayerInfo(string user) {
            return base.Channel.GetPlayerInfo(user);
        }
        
        public System.Threading.Tasks.Task<ConsoleClient.GameReferrence.Player> GetPlayerInfoAsync(string user) {
            return base.Channel.GetPlayerInfoAsync(user);
        }
        
        public ConsoleClient.GameReferrence.Player GetMyInfo() {
            return base.Channel.GetMyInfo();
        }
        
        public System.Threading.Tasks.Task<ConsoleClient.GameReferrence.Player> GetMyInfoAsync() {
